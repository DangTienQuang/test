    ...
    public class BookingService : IBookingService
    {
        ...
        public async Task<BookingResponseDTO> CreateWalkInBookingAsync(int staffId, CreateWalkInBookingDTO request)
        {
            ...
            if (vehicleTypeQuery == null)
            {
                ...
                {
                    otherVehicleType = new AutoWashPro.DAL.Entities.VehicleType
                    {
                        Name = "Khác",
                ...
                var newVehicle = new AutoWashPro.DAL.Entities.Vehicle
                {
                ...
                vehicleTypeQuery = new
                {
                    VehicleId = newVehicle.Id,
                    LicensePlate = newVehicle.LicensePlate,
                    BaseWeight = otherVehicleType.BaseWeight,
                    VehicleTypeId = otherVehicleType.Id
                };
            }
